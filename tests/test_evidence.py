...
EXPECTED_VISUAL_DIMENSIONS = {
    ...
    "distribution-contract": (1_440, 1_000),
    "distribution-terminal": (1_440, 520),
    "replay-terminal": (1_440, 900),
    "scaling": (1_440, 890),
    "unit-repair-lineage": (1_440, 900),
...
REQUIRED_README_EMBEDS = {
    ...
    "docs/assets/distribution-contract.png",
    "docs/assets/distribution-terminal.png",
    "docs/assets/replay-terminal.png",
    "docs/assets/scaling.png",
    "docs/assets/unit-repair-lineage.png",
